...
import com.example.yydkj.adapter.FragmentAdapter;
...
public abstract class BaseTablayoutFragment extends BaseFragment {
    ...
    protected View getSuccessView() {
        //获取数据
        View view = View.inflate(getContext(), R.layout.fragment_tab_and_viewpager, null);
    ...
    private void init() {
        ...
        mVpNewsShowLayout.setAdapter(new FragmentAdapter(getChildFragmentManager(), mShowItmes));
