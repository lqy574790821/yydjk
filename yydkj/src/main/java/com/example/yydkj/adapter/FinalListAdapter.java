...
import com.example.yydkj.bean.FootTypeBean;
import com.example.yydkj.bean.HeadTypeBean;
import com.example.yydkj.intefaces.BodyType;
import com.example.yydkj.intefaces.FootType;
import com.example.yydkj.intefaces.HeadType;
...
public class FinalListAdapter extends RecyclerView.Adapter<FinalViewHolder> {
    ...
    public void update() {
        ...
        //添加脚部
        if (mIsShowFootView) {
        mShowItems.add(new FootTypeBean());
        }
